...
class WhisperModelUI(object):
    def __init__(self, ui_obj):
        ...
        self.video_store_path = 'C:/Users/apex computers/Translation/data_files'
    ...
    def load_content(self, file_list):
        ...
        return gr.Dropdown(label="Saved Videos", choices=self.audio_files_list)
    ...
    def get_video_to_text(self,
        ...
        debug_text = ""
        try:
            video_out_path = os.path.join(os.getcwd(), 'C:/Users/apex computers/Translation/data_files')
                    ...
                    with gr.Row():
                        with gr.Column():
                            ...
                            youtube_url = gr.Textbox(label="YouTube URL",
                                                     ...
                                                     value="https://youtu.be/8bOzIfAeefc?si=37LGu0lUtQQHuuLC"
                                                     )
